...
md`## Race bar com as vitórias das construtoras`
)}

async function _data(d3,FileAttachment){return(
d3.csvParse(await FileAttachment("constructorsWinners@4.csv").text(), d3.autoType)
)}
...
Array.from(d3.rollup(data, ([d]) => d.wins, d => +d.year, d => d.constructorName))
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["constructorsWinners@4.csv", {url: new URL("./files/5df59672cac9a1c6e409037f850da3743cbfeb09f1db2f81875c07a0e0eaba4972c6b6d0f2eccc1e22ee15b7cd95bd30118bd541040973498e768164f5166565.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
